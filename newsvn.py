...
def find_bad_repositories(list_of_repos):
    ...
    for repo in list_of_repos:
        out, err, exit_code = proc.run(['/usr/bin/svn', 'status', '%s' % repo],
                                       timeout=10)
...
def fix(current_repository):
    out, err, exit_code = proc.run(['/usr/bin/svn', 'cleanup',
...
def remediate():
    ...
    repositories = ('/home/amro/myrepos/repo3',
                    '/home/amro/myrepos/repo2',
                    '/home/amro/myrepos/repo4')
    fixed_all_repos = []
